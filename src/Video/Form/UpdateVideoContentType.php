...
final class UpdateVideoContentType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('slug', TextType::class, [
                'label' => 'Slug',
                'required' => false,
                'help' => 'Laisse vide pour generer automatiquement depuis le titre.',
                'attr' => [
                    'class' => 'ds-input font-mono text-sm',
            ...
            ->add('description', TextareaType::class, [
                ...
                'empty_data' => '',
                'attr' => [
                    'class' => 'ds-input min-h-32',
                    'placeholder' => 'Description pedagogique complete de la video.',
                    'rows' => 6,
                ],
            ])
            ->add('level', EnumType::class, [
                ...
                'choice_label' => static fn (ContentLevel $level): string => match ($level) {
                    ContentLevel::BEGINNER => 'Debutant',
                    ContentLevel::INTERMEDIATE => 'Intermediaire',
                    ContentLevel::ADVANCED => 'Avance',
                },
                'attr' => [
                    'class' => 'ds-input',
                ],
            ...
            ->add('coverImagePath', TextType::class, [
                ...
                'required' => false,
                'help' => 'Chemin relatif ou URL deja hebergee. Upload a venir.',
                'attr' => [
                    'class' => 'ds-input',
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => UpdateVideoContentInput::class,
        ]);
    }
}
